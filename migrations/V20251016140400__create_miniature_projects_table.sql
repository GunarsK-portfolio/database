...
-- Create indexes
CREATE INDEX idx_miniature_projects_display_order ON miniatures.miniature_projects (
    display_order
);
CREATE INDEX idx_miniature_projects_theme_id ON miniatures.miniature_projects (
    theme_id
);
CREATE INDEX idx_miniature_projects_difficulty ON miniatures.miniature_projects (
    difficulty
);
CREATE INDEX idx_miniature_projects_manufacturer ON miniatures.miniature_projects (
    manufacturer
);
