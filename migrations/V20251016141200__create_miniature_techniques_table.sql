...
CREATE TABLE miniatures.miniature_techniques (
    ...
    CONSTRAINT unique_miniature_technique UNIQUE (
        miniature_project_id, technique_id
    )
);

-- Create indexes for queries
CREATE INDEX idx_miniature_techniques_miniature_id ON miniatures.miniature_techniques (
    miniature_project_id
);
CREATE INDEX idx_miniature_techniques_technique_id ON miniatures.miniature_techniques (
    technique_id
);
