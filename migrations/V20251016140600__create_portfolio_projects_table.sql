...
-- Create indexes
CREATE INDEX idx_portfolio_projects_display_order ON portfolio.portfolio_projects (
    display_order
);
CREATE INDEX idx_portfolio_projects_category ON portfolio.portfolio_projects (
    category
);
CREATE INDEX idx_portfolio_projects_featured ON portfolio.portfolio_projects (
    featured
);
