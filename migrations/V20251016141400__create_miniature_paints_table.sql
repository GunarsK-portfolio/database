...
CREATE INDEX idx_miniature_paints_miniature_id ON miniatures.miniature_paints (
    miniature_project_id
);
CREATE INDEX idx_miniature_paints_paint_id ON miniatures.miniature_paints (
    paint_id
);
