...
-- Add comment
COMMENT ON COLUMN audit.action_log.source IS 'Source application that initiated the action (admin-web, public-web, etc.). Defaults to ''unknown'' if not specified.';
