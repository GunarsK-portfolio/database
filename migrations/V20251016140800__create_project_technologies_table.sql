...
CREATE INDEX idx_project_technologies_project_id ON portfolio.project_technologies (
    project_id
);
CREATE INDEX idx_project_technologies_skill_id ON portfolio.project_technologies (
    skill_id
);
